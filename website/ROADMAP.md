...
- [x] **DT-02 — Conectar y verificar la URL canónica.** Verificado el 6 de septiembre de 2026: `lldmcoro.com` está asociado al proyecto Pages, responde HTTPS y vuelve a ser la fuente única de canonical, hreflang, Open Graph, sitemap, `robots.txt`, `llms.txt` y JSON-LD.
